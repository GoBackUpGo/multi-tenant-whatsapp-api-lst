...
const localCache = new Map(); // ÊÎÒíä ãÄÞÊ Ýí ÇáÐÇßÑÉ
...
router.get('/is-ready/:tenantId', async (req, res) => {
    ...
    // ÅÐÇ ßÇä áÏíäÇ äÊíÌÉ Ýí ÇáßÇÔ ÇáãÍáí¡ äÓÊÎÏãåÇ ãÈÇÔÑÉ
    ...
    // ÊÎÒíä ÇáÞíãÉ Ýí ÇáßÇÔ ÇáãÍáí áãÏÉ 10 ËæÇäò
    localCache.set(tenantId, isReady);
    setTimeout(() => localCache.delete(tenantId), 10 * 1000); // ÍÐÝ ÈÚÏ 10 ËæÇäò
